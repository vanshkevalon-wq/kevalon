...
export default function CareersPage() {
  ...
  return (
    <div className="bg-white overflow-x-hidden" style={{ fontFamily: "Inter,'Nunito Sans',sans-serif", color: '#0f172a' }}>
      ...
      {/* ══ OUR VALUES ══ */}
      <section className="bg-white py-14 sm:py-16 md:py-20 px-4 sm:px-8 md:px-12" id="values">
        <div
      ...
      {/* ══ PERKS & BENEFITS ══ */}
      <section className="relative overflow-hidden py-14 sm:py-16 md:py-20 px-4 sm:px-8 md:px-12" style={{ background:'#f8fafc', borderTop:'1.5px solid rgba(97,187,197,0.12)' }}>
      ...
      {/* ══ OPEN POSITIONS ══ */}
      <section className="bg-white py-14 sm:py-16 md:py-20 px-4 sm:px-8 md:px-12" id="positions">
        <div
          className="max-w-[1240px] mx-auto transition-opacity duration-300"
      ...
      <section className="py-14 sm:py-16 md:py-20 px-4 sm:px-8 md:px-12" style={{ background:'#f8fafc', borderTop:'1.5px solid rgba(97,187,197,0.12)' }}>
        <div
          className="max-w-[1240px] mx-auto transition-opacity duration-300"
