  ...
  return (
    <div className="bg-white font-['Inter','Nunito_Sans',sans-serif] overflow-x-hidden">
      ...
      <section ref={stats.ref} className="relative bg-white border-t border-[rgba(97,187,197,0.15)] px-4 sm:px-8 md:px-12 overflow-hidden">
        ...
        <div className="max-w-[1260px] mx-auto grid grid-cols-2 md:grid-cols-4 gap-0">
          {STATS.map((s,i) => (
            <div key={s.label}
              className={`relative flex items-center gap-3 sm:gap-4 px-4 sm:px-6 md:px-8 py-7 sm:py-10 transition-colors duration-200 hover:bg-[rgba(97,187,197,0.04)] group border-[rgba(97,187,197,0.12)]
              ...
              {i < STATS.length-1 && (
                <div className="hidden md:block absolute right-0 top-[15%] bottom-[15%] w-px" style={{ background:'linear-gradient(180deg,transparent,rgba(97,187,197,0.25),transparent)' }} />
              )}
