...
export default function AboutPage() {
  ...
  return (
    <div className="bg-white font-[Inter,'Nunito_Sans',sans-serif] text-[#0f172a] overflow-x-hidden">
      ...
      {/* ══ MISSION & VISION ══ */}
      <section className="bg-white py-24 px-12 max-md:py-[72px] max-md:px-6">
        <div
      ...
      {/* ══ WHY US ══ */}
      <section className="relative bg-white border-t-[1.5px] border-[rgba(97,187,197,0.12)] py-24 px-12 overflow-hidden max-md:py-[72px] max-md:px-6">
        <div
